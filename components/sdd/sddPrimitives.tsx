...
export const sddPrimitives = {
    // Fonts
    font: 'font-[Segoe UI,Tahoma,Geneva,Verdana,sans-serif]',

    // Headings (Matching properties of SRS primitives but accessible as SDD specific if drift occurs)
    ...
    th: 'border border-[#1a1a1a] p-2 bg-[#FDE9D9] font-bold text-center',
    td: 'border border-[#1a1a1a] p-2',

    // Layout
    pageBreak: 'break-before-page print:block hidden h-0',
