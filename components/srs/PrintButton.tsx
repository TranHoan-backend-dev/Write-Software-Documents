...
export const PrintButton = () => {
    ...
    return (
        <div className="fixed bottom-5 right-5 z-50 print:hidden flex flex-col gap-3">
            ...
            <Button
                onPress={handlePrint}
                className="bg-blue-600 hover:bg-blue-700 text-white font-bold shadow-lg rounded-full h-14 w-14 min-w-14 px-0 flex items-center justify-center p-0"
